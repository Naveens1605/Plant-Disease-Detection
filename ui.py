...
title = tk.Label(text="Click below to choose picture for testing disease....", background = "yellow", fg="red", font=("", 15))
title.grid()
def bact():
    window.destroy()
    window1 = tk.Tk()

    window1.title("Remedies of Disease")
    ...
    remedies = tk.Label(text=rem, background="yellow",
                      fg="Brown", font=("", 15))
    ...
    remedies1 = tk.Label(text=rem1, background="yellow",
                        fg="Black", font=("", 12))
...
def analysis():
    ...
    for num, data in enumerate(verify_data):
        ...
        message = tk.Label(text='Status: '+status, background="yellow",
                           fg="Brown", font=("", 15))
        message.grid(column=0, row=3, padx=10, pady=10)
        if str_label == 'bacterial':
            diseasename = "Bacterial Spot "
            disease = tk.Label(text='Disease Name: ' + diseasename, background="yellow",
                               fg="Black", font=("", 15))
            disease.grid(column=0, row=4, padx=10, pady=10)
            r = tk.Label(text='Click below for remedies...', background="yellow", fg="Brown", font=("", 15))
...
def openphoto():
    ...
    fileName = askopenfilename(initialdir='C:/Users/Naveen/Documents/PycharmProjects/Image Processing/venv/test/test', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = "C:/Users/Naveen/Documents/PycharmProjects/Image Processing/venv/testpicture"
